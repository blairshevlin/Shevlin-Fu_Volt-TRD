...
# Reads source data from data/figures/figure1_panel_source_data.csv
...
# Load source data
source_data <- read.csv(here::here("data/figures/figure1_panel_source_data.csv"), stringsAsFactors = FALSE)
...
# Save the figure
ggsave(file.path(res_dir, "Figure1_PanelC.png"),
       plot = final_figure,
       device = "png",
       width = 12,
       height = 4,
...
ggsave(file.path(res_dir, "Figure1_PanelC.pdf"),
       plot = final_figure,
       device = "pdf",
       width = 12,
       height = 4,
